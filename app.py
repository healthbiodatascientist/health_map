...
app.layout = dbc.Container([
    ...
    html.Li(html.Cite("https://www.opendata.nhs.scot/dataset/7e21f62c-64a1-4aa7-b160-60cbdd8a700d/resource/5d55964b-8e45-4c49-bfdd-9ea3e1fb962d/download/beds_by_nhs_board-of-treatment_specialty.csv")),
    html.Li(html.Cite("https://www.opendata.nhs.scot/dataset/0d57311a-db66-4eaa-bd6d-cc622b6cbdfa/resource/a5f7ca94-c810-41b5-a7c9-25c18d43e5a4/download/weekly_ae_activity_20250810.csv")),
    html.Li(html.Cite("https://publichealthscotland.scot/media/29058/table-3-multiple-emergency-admissions-2023-24.xlsx")),
    html.Summary("Scottish Ambulance Service"),
    html.Li(html.Cite("https://www.scottishambulance.com/publications/previous-unscheduled-care-operational-statistics/")),
